...
public class Choice_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_q7klwl_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_q7klwl_a0(editorContext, node));
  ...
  private EditorCell createProperty_q7klwl_a0(EditorContext editorContext, SNode node) {
