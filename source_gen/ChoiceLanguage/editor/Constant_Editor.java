...
public class Constant_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_b5vi9g_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_b5vi9g_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_b5vi9g_a0(EditorContext editorContext, SNode node) {
