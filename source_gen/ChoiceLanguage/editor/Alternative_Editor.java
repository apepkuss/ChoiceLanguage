...
public class Alternative_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ods2m7_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_ods2m7_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_ods2m7_a0(EditorContext editorContext, SNode node) {
