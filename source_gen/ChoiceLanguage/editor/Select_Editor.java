...
public class Select_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2tw2dk_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_2tw2dk_b0(editorContext, node));
  ...
  private EditorCell createProperty_2tw2dk_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
    provider.setRole("DimName");
    provider.setNoTargetText("<no DimName>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    editorCell.setCellId("property_DimName");
